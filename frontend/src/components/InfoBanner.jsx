...
const CC_ELECTION_REGISTRATION_END_MS = Date.UTC(2026, 4, 31, 0, 0, 0);
...
function getCcElectionBanner(nowMs) {
  if (nowMs < CC_ELECTION_REGISTRATION_END_MS) {
    return <>Candidate registration begins{" "}<strong>1 May 2026 at 21:45 UTC</strong> and remains open until <strong>31 May 2026</strong>.</>;
  }
