<!-- url: ipfs://bafkreideu6p3kjrrdjviewitukkrit34nle73ex2lv454d5rujj3437icu -->
# William Doyle
...
**Quote 3** 
    ...
    instead of treating all approved proposals in one TWGA, on-chain approvals will now be divided as follows:

        Proposals approved with ≥67% – <75% support
        Proposals approved with ≥75% – 100% support

Quote 3 is particularly frustrating because it asserts that the alternative to this proposal would be a single TWGA, whereas in actual fact last year we had individual on-chain approvals for each proposal. 
