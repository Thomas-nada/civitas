<!-- url: https://most-brass-sun.quicknode-ipfs.com/ipfs/Qmc5gRZ8NFQA5goJuZ89FTtFQEAAr4uoqb5WUNCuyd88DS -->
# hix_coffeepool☕️
...
本提案に反対票を投じます。DRepとして、私はすべてのトレジャリー引き出しガバナンスアクションを、公開している投票フレームワークに基づいて評価しています。本提案は**Tier 4 — アプリケーション層**に分類されます：非カストディアル型ウォレットアプリケーションです。この分類は提案の質や重要性への評価ではなく、プロジェクトの種類と適切な資金調達手段を示すものです。アプリケーション層のプロダクトはユーザーに直接価値を提供するものであり、恩恵を受ける人々が資金を負担すべきと考えます。
参考: https://coffeepool.jp/notes/drep-voting-framework-for-sustainable-ecosystem-jp/
