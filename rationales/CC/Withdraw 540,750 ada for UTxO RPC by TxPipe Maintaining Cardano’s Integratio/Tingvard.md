<!-- url: https://ipfs.blockfrost.dev/ipfs/QmSBgiUW57TP1sxFRUze81aXiCx4cmMRCTnYkbSP2jRJr5 -->
# Tingvard
...
This governance action requests 540,750 ADA from the Cardano Treasury to fund 12 months of maintenance and enhancement for UTxO RPC by TxPipe.

The proposal identifies the purpose of the withdrawal, the amount requested, the delivery period, and the intended scope of work. It states that the funding will support maintenance of the UTxO RPC specification, official SDKs, protocol compatibility, versioning, documentation, dependency updates, performance improvements, bug fixing, community support, external contribution review, and AI-friendly documentation and integration resources.

The proposal discloses prior treasury and ecosystem funding received by TxPipe, including Project Catalyst funding and open-source maintenance funding through Intersect’s 2025 budget cycle.
