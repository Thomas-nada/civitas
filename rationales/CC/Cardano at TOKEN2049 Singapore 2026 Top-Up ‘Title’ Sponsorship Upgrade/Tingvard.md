<!-- url: https://ipfs.blockfrost.dev/ipfs/QmVj6KnXehydvY2kEEWjFVQyRpSGE4ygFV2fnPMuj39tT8 -->
# Tingvard
...
The proposal allocates funding for independent audits, legal review, compliance, and oversight mechanisms, satisfying Article II, Section 7, §4.
The proposal further states that administrator-held funds will be kept in auditable accounts, will not be delegated to SPOs, and will be delegated only to the predefined auto-abstain DRep option, satisfying Article II, Section 7, §6.
...
The proposal includes immutable hosting, a document hash, and supporting references in accordance with Article II, Section 6, §1.
