<!-- url: https://ipfs.blockfrost.dev/ipfs/QmQYGVeRZ7HEFUFJg4wB62euPE6T3Dd7BXZfDRsXzBLZfm -->
# Tingvard
...
The proposal defines Cardano Foundation as administrator, with fund management through smart contracts and oversight by DQuadrant, Intersect, NMKR, and Sundae Labs, satisfying Article II, Section 7, §5.
The proposal allocates funding for audits, assurance, and oversight mechanisms, satisfying Article II, Section 7, §4.
The proposal further states that treasury and vendor contract addresses will not delegate to SPOs and will be delegated only to the predefined auto-abstain DRep option, satisfying Article II, Section 7, §6.
